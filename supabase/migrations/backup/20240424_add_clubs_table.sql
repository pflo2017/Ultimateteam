...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Clubs are viewable by their admin' AND tablename = 'clubs'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Clubs are updatable by their admin' AND tablename = 'clubs'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Clubs are deletable by their admin' AND tablename = 'clubs'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Teams are viewable by club admin' AND tablename = 'teams'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Teams are insertable by club admin' AND tablename = 'teams'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Teams are updatable by club admin' AND tablename = 'teams'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Teams are deletable by club admin' AND tablename = 'teams'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Coaches are viewable by club admin' AND tablename = 'coaches'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Coaches are insertable by club admin' AND tablename = 'coaches'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Coaches are updatable by club admin' AND tablename = 'coaches'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Coaches are deletable by club admin' AND tablename = 'coaches'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Players are viewable by club admin' AND tablename = 'players'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Players are insertable by club admin' AND tablename = 'players'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Players are updatable by club admin' AND tablename = 'players'
  ) THEN
    EXECUTE $policy$
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Players are deletable by club admin' AND tablename = 'players'
  ) THEN
    EXECUTE $policy$
