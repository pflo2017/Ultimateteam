...
CREATE TABLE IF NOT EXISTS public.activity_events (
  ...
  activity_id TEXT NOT NULL, -- References activities(id) - can be UUID or composite ID for recurring activities
  ...
  metadata JSONB DEFAULT '{}'::jsonb, -- For additional event data
